...
MASTER_DATA = {
    "Bank Pre": {
        ...
        "subjects": ["None", "Reasoning", "Quants", "English", "General Awareness", "Current Affairs", "Hindi", "Computer"]
    },
    "Bank Post": {
        "exams": ["JAIIB", "CAIIB", "IIBF CERTIFICATION COURSE", "BANK PROMOTION EXAMS"],
        "subjects": ["None", "AFM", "RBWM", "IEIFS", "PPB", "ABM", "ABFM", "BFM", "BRBL", "CAIIB Elective Subjects", 
    ...
    "SSC": {
        ...
        "subjects": ["None", "Current Affairs", "English", "GK/GS", "Maths", "Reasoning", "Science", "Shorthand"]
    },
    "Teaching": {
        ...
        "subjects": ["None", "English", "Hindi", "Maths", "Sanskrit", "CDP", "EVS", "General Studies", "Commerce", "Urdu", 
    ...
    "UGC": {
        ...
        "subjects": ["None", "General Paper", "Political Science", "Philosophy", "Psychology", "Sociology", "History", 
    ...
    "Bihar": {
        ...
        "subjects": ["None", "Hindi", "Maths", "GK/GS", "Reasoning", "English", "Science", "Current Affairs", 
    ...
    "Punjab": {
        ...
        "subjects": ["None", "Static & Current Affairs", "General Knowledge", "Basic Computer Knowledge", 
    ...
    "Odia": {
        ...
        "subjects": ["None", "Current Affairs", "Reasoning", "English", "GK/GS", "Geography", "History", "Polity", 
    ...
    "Telugu": {
        ...
        "subjects": ["None", "Mathematics", "Reasoning", "Polity", "Economy", "History", "Geography", "Current Affairs", 
    ...
    "Tamil": {
        ...
        "subjects": ["None", "Current Affairs", "English", "Maths", "Geography", "Science", "Psychology", "GK", 
                    "Reasoning", "Biology", "Polity", "History", "GS"]
    },
    "Bengal": {
        "exams": ["WBSSC GROUP C & D", "SSC MTS", "RRB NTPC", "WBP", "Banking", "WBCS"],
        "subjects": ["None", "Current Affairs", "History", "Polity", "Mathematics", "Gk", "Gs", "English", 
    ...
    "Agriculture": {
        ...
        "subjects": ["None", "Agronomy", "Genetics & Plant Breeding", "Entomology", "Soil Science", 
