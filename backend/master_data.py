...
MASTER_DATA = {
    "Bank Pre": {
        ...
        "subjects": ["Reasoning", "Quants", "English", "General Awareness", "Current Affairs", "Hindi", "Computer"]
    },
    "Bank Post": {
        "exams": ["JAIIB", "CAIIB", "IIBF CERTIFICATION COURSE", "BANK PROMOTION EXAMS"],
        "subjects": ["AFM", "RBWM", "IEIFS", "PPB", "ABM", "ABFM", "BFM", "BRBL", "CAIIB Elective Subjects", 
    ...
    "SSC": {
        ...
        "subjects": ["Current Affairs", "English", "GK/GS", "Maths", "Reasoning", "Science", "Shorthand"]
    },
    "Teaching": {
        ...
        "subjects": ["English", "Hindi", "Maths", "Sanskrit", "CDP", "EVS", "General Studies", "Commerce", "Urdu", 
    ...
    "UGC": {
        ...
        "subjects": ["General Paper", "Political Science", "Philosophy", "Psychology", "Sociology", "History", 
    ...
    "Bihar": {
        ...
        "subjects": ["Hindi", "Maths", "GK/GS", "Reasoning", "English", "Science", "Current Affairs", 
    ...
    "Punjab": {
        ...
        "subjects": ["Static & Current Affairs", "General Knowledge", "Basic Computer Knowledge", 
    ...
    "Odia": {
        ...
        "subjects": ["Current Affairs", "Reasoning", "English", "GK/GS", "Geography", "History", "Polity", 
    ...
    "Telugu": {
        ...
        "subjects": ["Mathematics", "Reasoning", "Polity", "Economy", "History", "Geography", "Current Affairs", 
    ...
    "Tamil": {
        ...
        "subjects": ["Current Affairs", "English", "Maths", "Geography", "Science", "Psychology", "GK", 
                    "Reasoning", "Biology", "Polity", "History", "GS"]
    },
    "Bengal": {
        "exams": ["WBSSC GROUP C & D", "SSC MTS", "RRB NTPC", "WBP", "Banking", "WBCS"],
        "subjects": ["Current Affairs", "History", "Polity", "Mathematics", "Gk", "Gs", "English", 
    ...
    "Agriculture": {
        ...
        "subjects": ["Agronomy", "Genetics & Plant Breeding", "Entomology", "Soil Science", 
